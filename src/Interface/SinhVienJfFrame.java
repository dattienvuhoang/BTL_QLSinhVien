 ...
 * @author Dat
 */
public class SinhVienJfFrame extends javax.swing.JFrame {

    /**
     * Creates new form SinhVienJfFrame
     */
    public SinhVienJfFrame(SinhVien sinhVien, String type) {
        initComponents();
        if (type.equalsIgnoreCase("Student")||type.equalsIgnoreCase("Teacher"))
        {
            btnSave.setVisible(false);
        }
        SinhVienController controller = new SinhVienController(btnSave, jtfMaSV,jtfHoTen,jtfSDT,jtfMaLop,jtfQueQuan,jdcNgaySinh,rdNam,rdNu);
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        String maSinhVien = jtfMaSV.getText();
        ...
        Statement sta = null ; 
        int result = JOptionPane.showConfirmDialog(null, "Bạn có muốn lưu thông tin sinh viên này vào cơ sở dữ liệu không?", "Xác nhận lưu sinh viên", JOptionPane.YES_NO_OPTION);
